...
const Error404: NextPage = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen px-5 text-gray-50 text-center bg-black-400 font-sans">
      ...
      <Link
        href="/"
        className="mt-2.5 px-6 py-3 text-base font-semibold bg-gray-50 rounded-full shadow-md border 
                   transition-all hover:scale-105 hover:no-underline drop-shadow-sm text-black-500 no-underline hover:text-black-500"
      >
        홈으로 가기
      </Link>
    </div>
